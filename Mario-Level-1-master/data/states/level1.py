...
class Level1(tools._State):
    ...
    def startup(self, current_time, persist):
        ...
        self.game_info[c.PAUSE] = c.PAUSE
    ...
    def update(self, surface, keys, current_time):
        ...
        self.blit_everything(surface,self.game_info)
    ...
    def pause(self,keys):
        if keys[tools.keybinding['exit_pause']]:
    ...
    def update_all_sprites(self, keys):
        ...
        self.overhead_info_display.update(self.game_info, self.mario)
        if keys[pg.K_ESCAPE]:
            self.game_info[c.LEVEL_STATE] = self.state = c.PAUSE
    ...
    def blit_everything(self, surface,game_info):
        ...
        self.overhead_info_display.draw(surface,game_info)
        for score in self.moving_score_list:
            score.draw(surface)
